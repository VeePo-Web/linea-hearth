        ...
        <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
          <tr>
            <td align="center">
              ...
              <a href="mailto:1.lineofjudah.1@gmail.com" style="font-family:-apple-system,BlinkMacSystemFont,'Helvetica Neue',sans-serif;font-size:14px;color:#FFFFFF;text-decoration:none;">1.lineofjudah.1@gmail.com</a>
            </td>
          </tr>
          <tr>
            <td align="center" style="padding-top:24px;">
              ...
              <p style="margin:0;font-family:-apple-system,BlinkMacSystemFont,'Helvetica Neue',sans-serif;font-size:13px;color:#A8A29E;font-style:italic;">— Olliver Abbey and the Line of Judah Team</p>
            </td>
          </tr>
          <tr>
            <td align="center" style="padding-top:24px;">
