          ...
          <div className="max-w-lg">
            ...
            <ScrollReveal variant="fadeUp" delay={0.1} className="lg:hidden mb-6">
              <div>
                ...
                <p className="text-sm font-medium text-stone-950">Marcus T.</p>
                <p className="text-caption text-stone-500">Youth Pastor • Atlanta, GA</p>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal variant="fadeUp" delay={0.2}>
              <blockquote className="mb-6 md:mb-8">
                <TextReveal 
                  ...
                  className="text-2xl xs:text-3xl md:text-4xl lg:text-hero text-stone-950 leading-snug md:leading-tight"
                  as="span"
                  delay={0.3}
                />
                <motion.span 
